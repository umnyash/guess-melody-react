...
import { MAX_MISTAKE_COUNT, AppRoute, AuthorizationStatus, NameSpace } from '../../const';
import App from './app';
...
describe('Application Routing', () => {
  ...
  it('should render "WelcomeScreen" when user navigate to "/"', () => {
    ...
    expect(screen.getByText(new RegExp(`Можно допустить ${MAX_MISTAKE_COUNT} ошибки.`, 'i'))).toBeInTheDocument();
  });
